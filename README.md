...
For this project, I chose the Clean Architecture for the backend and Atomic Design for the frontend. In both cases, the choice is not only related to familiarity and a positive past experience with these architectures, but also due to their significant advantages in terms of implementation speed, segregation of responsabilities and cleanness of code.
